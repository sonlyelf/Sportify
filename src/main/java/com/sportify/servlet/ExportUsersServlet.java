...
@Controller
@RequestMapping("/ExportUserServlet")
	  ...
	  @RequestMapping(method = RequestMethod.POST)
	    protected void doPost(HttpServletRequest request, HttpServletResponse response)
		  ...
		  // 创建一个新的工作簿
	        ...
	        // 创建一个工作表
	        XSSFSheet sheet = workbook.createSheet("ALLUsers");
	        ...
	        // 创建表头行
	        String[] headers = {"ID", "Name", "BirthDay", "Phone", "Email"};
	        ...
	        response.setHeader("Content-Disposition", "attachment; filename=bkUsers.xlsx");
