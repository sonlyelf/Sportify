              ...
              <div class="container-xl">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <div class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="./announcement.html">課程介紹</a></li>
...
<section id="course-intro" class="course-intro">
  <div class="content">
      ...
      <p>
          ...
          藉由和緩地滾動來深度拓展肩背部的肌肉，以及按摩骨盆、大腿，
          促進血液循環之餘也能訓練平衡感，鍛鍊腹部核心，在安全穩定中
          暢快放鬆，不論是對入門的瑜伽初學者，或是想進階練習瑜伽的
          同學都非常有幫助。
      </p>
  </div>
  <hr>
  <div class="content">
    ...
    <p>
      ...
      練習陰瑜珈Yin Yoga能夠幫助這些人放鬆身心、治癒創傷和打開身體。
      陰瑜珈還適合上半身力量欠缺的人或者不經常練習瑜珈的人。
      陰瑜珈Yin Yoga能使任何練習的人感到青春煥發、神清氣爽、美麗倍增。
  ...
  <div class="content">
    ...
    訓練到你的腿部、手臂、背部和肩膀，對核心部位有顯著效果。 在課程中讓你能快速消耗卡路里、提高協調性、敏捷性和速度，提升肌耐力,全程可以燃燒高達740卡路里的熱量。 此項課程受武術動作啟發，是完全非接觸性、簡單易學的大運動量訓練課程。
    </p>
  </div>
  <hr>
  <div class="content">
  ...
  <div class="content">
    ...
    <p>
      ...
      簡單易上手、有效且相當有趣的訓練課程，是RADICAL FITNESS最特別的項目之一。
    </p>
