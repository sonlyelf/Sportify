...
<body data-bs-spy="scroll" data-bs-target="#navbarSupportedContent"
	...
	<div class="col-12 banner">
		...
		<img src="../image/ToDaybig.png" alt="..."> </picture>
	</div>
		...
		<div class="container mb-5 mt-3">
			<div class="row">
				...
				<section id="course-intro" class="course-intro">
					<div class="content">
						<img src="../image/yogacircle.jpeg" width="300px" height="auto"
							alt="Yoga Circle">
						<h3>Yoga Wheel瑜珈輪</h3>
						<p>透過圓形中空輔具的幫助，保持瑜伽練習時後彎等動作的穩定度， 藉由和緩地滾動來深度拓展肩背部的肌肉，以及按摩骨盆、大腿，
							促進血液循環之餘也能訓練平衡感，鍛鍊腹部核心，在安全穩定中 暢快放鬆，不論是對入門的瑜伽初學者，或是想進階練習瑜伽的
							同學都非常有幫助。</p>
					</div>
					<hr>
					<div class="content">
						<img src="../image/gettyimages-1663038026.jpg" width="300px"
							height="auto" alt="YinYoga">
						<h3>YinYoga 陰瑜珈</h3>
						<p>陰瑜珈Yin Yoga也適宜瑜伽初學者、工作壓力大的人和身體有傷之人練習。 練習陰瑜珈Yin
							Yoga能夠幫助這些人放鬆身心、治癒創傷和打開身體。 陰瑜珈還適合上半身力量欠缺的人或者不經常練習瑜珈的人。 陰瑜珈Yin
							Yoga能使任何練習的人感到青春煥發、神清氣爽、美麗倍增。
							在練習其它瑜伽(流瑜珈或熱瑜珈)的同時穿插練習陰瑜珈能使你的瑜珈練習達到一個平衡狀態。</p>
					</div>
					<hr>

					<div class="content">
						<img src="../image/pexels-ketut-subiyanto-4999475.jpg"
							width="300px" height="auto" alt="YinYoga">
						<h3>空中舒緩瑜珈</h3>
						<p>
					...
					<hr>
					<div class="content">
						<img src="../image/FunctionalTraining.jpg" width="300px"
							height="auto" alt="YinYoga">
						<h3>肌力循環式訓練</h3>
						<p>循環式訓練（Circuit training）是一種使用肌力訓練來挑戰能量代謝系統的訓練，
							其中包含了許多訓練動作，從自由重量到機械式阻力訓練和徒手肌力訓練都能夠拿來設計成課表，
							簡單來說就是在許多的訓練動作中進行連續的訓練，每個訓練之間都夾雜短暫的休息， 由這些的訓練所組成的就稱為循環訓練。</p>
					</div>
					<hr>
					<div class="content">
						<img src="../image/b_ow0l3HccEXONmgGWflO9.webp" width="300px"
							height="auto" alt="YinYoga">
						<h3>BODY COMBAT拳擊有氧</h3>
						<p>BODY COMBAT又稱為「拳擊有氧、戰鬥有氧」，通過上半身打拳、下半身踢腿動作進行鍛煉，
							訓練到你的腿部、手臂、背部和肩膀，對核心部位有顯著效果。
							在課程中讓你能快速消耗卡路里、提高協調性、敏捷性和速度，提升肌耐力,全程可以燃燒高達740卡路里的熱量。
							此項課程受武術動作啟發，是完全非接觸性、簡單易學的大運動量訓練課程。</p>
					</div>
					<hr>
					<div class="content">
						<img src="../image/ZumbaDanceWorkout.jpeg" width="300px"
							height="auto" alt="YinYoga">
						<h3>ZUMBA</h3>
						<p>
							...
							不用記太多繁瑣的動作，如果你是這種無法記住舞步的人，放心，跟著音樂動滋動就對了!</p>
					</div>
					<hr>
					<div class="content">
						<img src="../image/rtx.jpg" width="300px" height="auto"
							alt="YinYoga">
						<h3>TRX 循環式訓練</h3>
						<p>
					...
					<hr>
					<div class="content">
						<img src="../image/kettle-belljpg.jpeg" width="300px"
							height="auto" alt="YinYoga">
						<h3>Kettlebell 壺鈴</h3>
						<p>
							近年來壺鈴訓練廣受歡迎，越來越多人開始嚐試，並愛上它帶來的運動效能！是一種拿來訓練全身力量及體能的工具。效率高、體積小，在更短的時間內即達到全身運動的高效能是非常實用的訓練器材。
							壺鈴訓練透過各種深蹲、硬舉、擺盪、上搏、挺舉、划船...等訓練模式，結合有氧和阻力訓練，可以促使身體力量的產生，激發耐力與爆發力。
						</p>
					</div>
					<hr>
					<div class="content">
						<img src="../image/UBOUND.JPG" width="300px" height="auto"
							alt="YinYoga">
						<h3>UBOUND®活力躍蹦</h3>
