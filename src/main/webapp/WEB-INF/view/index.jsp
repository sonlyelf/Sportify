                        ...
                        <div class="container-xl">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <div class="navbar-nav ms-auto">
                                    <li class="nav-item"><a class="nav-link active" href="/index">訊息公告</a></li>
                    ...
                    <div class="carousel-item">
                        <picture>
                            ...
                            <source media="(min-width:300px)"
                                srcset="../image/pexels-valeria-ushakova-603898-3094215.jpg">
        ...
        <section id="sec1">
            ...
            <nav>
                <div class="nav nav-tabs justify-content-center" id="nav-tab" role="tablist">
                    <button class="nav-link active" id="p1-tab" data-bs-toggle="tab" data-bs-target="#p1" type="button" role="tab" aria-controls="p1" aria-selected="true">活動消息</button>
                    <button class="nav-link" id="p2-tab" data-bs-toggle="tab" data-bs-target="#p2" type="button" role="tab" aria-controls="p2" aria-selected="false">教室公告</button>
                </div>
            </nav>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-4 p-3" data-no="1">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#prodModel1">
                                    ...
                                    <img src="../image/newOpen.png" class="d-block mw-100 mx-auto rounded-2 mb-2" data-bs-toggle="modal" data-bs-target="#prodModel1" alt="">
                                </a>
                            </div>
                            <!-- Modal -->
                            ...
                            <div class="col-12 col-sm-6 col-md-4 p-3" data-no="2">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#prodModel2">
                                    <p class="text-center"></p>
                                    <img src="../image/membercard.png" class="d-block mw-100 mx-auto rounded-2 mb-2" data-bs-toggle="modal" data-bs-target="#prodModel2" alt="">
                                </a>
                            </div>
                            <!-- Modal -->
                            <div class="modal fade" id="prodModel2" tabindex="-1" aria-labelledby="prodModelLabel"
                                aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                            ...
                            <div class="col-12 col-sm-6 col-md-4 p-3" data-no="3">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#prodModel3">
                                    <p class="text-center"></p>
                                    <img src="../image/newcom.png" class="d-block mw-100 mx-auto rounded-2 mb-2" data-bs-toggle="modal" data-bs-target="#prodModel3" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container-xl">
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-4 p-3">
                                <p class="text-center"></p>
                                <img src="../image/classroom.png" class="d-block mw-100 mx-auto rounded-2 mb-2" data-bs-toggle="modal" data-bs-target="#prodModel4" alt="">
                            </div>
                            <!-- Modal -->
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-left">
                                            ...
                                            <p>4.為維持清潔安全，本教室嚴禁吸煙、喝酒、嚼食檳榔、口香糖及攜帶雨具、寵物(導盲犬除外)或任何食品入場(開水、礦泉水除外)。</p>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            <!-- 如果需要其他按鈕，可以在這裡添加 -->
                            ...
                            <div class="col-12 col-sm-6 col-md-4 p-3">
                                <p class="text-center"></p>
                                <img src="../image/obj.png" class="d-block mw-100 mx-auto rounded-2 mb-2" data-bs-toggle="modal" data-bs-target="#prodModel5" alt="">
                            </div>
                            <!-- Modal -->
                            ...
                            <div class="col-12 col-sm-6 col-md-4 p-3">
                                <p class="text-center"></p>
                                <img src="../image/rentRoom.png" class="d-block mw-100 mx-auto rounded-2 mb-2" data-bs-toggle="modal" data-bs-target="#prodModel6" alt="">
                            </div>
                            <!-- Modal -->
